...
if ( function_exists( 'wp_nav_menu' ) ) {
	...
	register_nav_menus( array( 'widget-hotels' => __( 'Widgets of hotels', 'woothemes' ) ) );
	register_nav_menus( array( 'widget-ver-hotels' => __( 'Widgets view-hotels', 'woothemes' ) ) );
	register_nav_menus( array( 'widget-hotels-ny' => __( 'Widgets hotel-ny', 'woothemes' ) ) );
}
...
function woo_load_prettyphoto () {
	...
	if ( ! isset( $woo_options['woo_enable_lightbox'] ) || $woo_options['woo_enable_lightbox'] == 'true' ) { return; }
